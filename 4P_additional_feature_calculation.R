source("./0_presets.R")
load("./Merged, Imputated, Uncalculated Features (Prediction).RData")
...
data <- pred_data[,c(2,grep("ZMBH_Mouse",names(pred_data)))]
data_all <- mouse
# Timepoint Mean
...
# Merge
pred_data <- pred_data[,-grep("ZMBH_Mouse",names(pred_data))] %>% cbind(.,imputed_data)

# 1.2 ZMBH Human Testis -----
data <- pred_data[,c(1,grep("ZMBH_Human",names(pred_data)))]
data_all <- human
...
# Merge
pred_data <- pred_data[,-grep("ZMBH_Human",names(pred_data))] %>% cbind(.,imputed_data)

# 1.3 GTEx Human Testis -----
data <- pred_data[,c(1,grep("GTEx_Human",names(pred_data)))]
...
# Merge
pred_data <- cbind(pred_data,imputed_data)
...
data <- pred_data[,c(1,grep("GSE107644_Mouse",names(pred_data)))]
# Cell-Type SPM
...
pred_data <- cbind(pred_data,to_merge_data)

# 2.2 (Mus Somat) GSE112393 -----
data <- pred_data[,c(1,grep("GSE112393_Mouse",names(pred_data)))]
# Cell-Type SPM
...
data <- pred_data[,c(1,grep("GSE136220_Mouse",names(pred_data)))]
# Cell-Type SPM
...
data <- pred_data[,c(1,grep("GSE148032_Mouse",names(pred_data)))]
# Cell-Type SPM
...
data <- pred_data[,c(1,grep("GSE106487_Human",names(pred_data)))]
# Cell-Type SPM
...
data <- pred_data[,c(1,grep("Lab_Human",names(pred_data)))]
# Cell-Type SPM
...
data <- pred_data[,c(1,grep("GSE134144_Human",names(pred_data)))]
# Cell-Type SPM
...
data <- pred_data[,c(1,grep("GSE124263_Human",names(pred_data)))]
# Cell-Type SPM
...
data <- pred_data[,c(1,grep("GSE112013_Human",names(pred_data)))]
# Cell-Type SPM
...
data <- pred_data[,c(1,grep("GSE142585_Human",names(pred_data)))]
# Cell-Type SPM
...
data <- pred_data[,c(1,grep("GSE86146_Human",names(pred_data)))]
# Cell-Type SPM
...
save(pred_data,file = "Merged, Imputated, Calculated Features (Prediction).RData")
